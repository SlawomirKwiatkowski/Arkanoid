...
void CSetingsState::updateButtons()
{
	...
	{
		this->states->push(new CMapChoosingState(this->window, this->states,this->font,3.f));
	}
	...
	{
		this->states->push(new CMapChoosingState(this->window, this->states, this->font,9.f));
	}
